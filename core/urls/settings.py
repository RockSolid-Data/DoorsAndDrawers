...
from ..views.settings import (
    ...
    show_door_style_add, cancel_door_style_add, add_door_style, delete_door_style,
    edit_wood_stock, get_wood_stock, update_wood_stock,
    show_wood_stock_add, cancel_wood_stock_add, add_wood_stock, delete_wood_stock,
    edit_door_design, get_door_design, update_door_design,
    show_door_design_add, cancel_door_design_add, add_door_design, delete_door_design,
    edit_edge_profile, get_edge_profile, update_edge_profile,
    show_edge_profile_add, cancel_edge_profile_add, add_edge_profile, delete_edge_profile,
    edit_panel_rise, get_panel_rise, update_panel_rise,
    show_panel_rise_add, cancel_panel_rise_add, add_panel_rise, delete_panel_rise,
    edit_panel_type, get_panel_type, update_panel_type,
    show_panel_type_add, cancel_panel_type_add, add_panel_type, delete_panel_type,
    ...
    show_drawer_woodstock_add, cancel_drawer_woodstock_add, add_drawer_woodstock, delete_drawer_woodstock,
    show_drawer_bottom_add, cancel_drawer_bottom_add, add_drawer_bottom, delete_drawer_bottom,
    show_drawer_pricing_add, cancel_drawer_pricing_add, add_drawer_pricing, delete_drawer_pricing,
